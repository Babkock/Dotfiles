...
[{
    ...
    "modules-right": ["mpd", "pulseaudio", "cpu", "memory", "battery", "disk", "temperature", "backlight", "custom/clock"],
    "sway/workspaces": {
...
#+begin_src json :tangle hconfig.json
    ...
    "output": "HDMI-A-2",
    "modules-left": ["wlr/workspaces"],
    "modules-right": ["disk", "temperature", "network", "idle_inhibitor", "wireplumber", "bluetooth", "custom/clock"],
    "wlr/workspaces": {
         "disable-scroll": false,
         "all-outputs": false,
         "format": "{icon}",
