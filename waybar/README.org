...
"disk": {
    ...
    "on-click-right": "pcmanfm /mnt/mega"
},
#+end_src
...
#+begin_src json :tangle hyprland.json
    ...
    "modules-right": ["disk", "network", "idle_inhibitor", "privacy", "wireplumber", "keyboard-state", "temperature", "tray"],
    "hyprland/workspaces": {
         "disable-scroll": false,
         "all-outputs": false,
         "show-special": true,
