...
#cpu, #wireplumber.muted, #pulseaudio.muted, #privacy {
    color:#f2172b;
    background:linear-gradient(0deg, rgba(226, 7, 27, 0.5), rgba(0, 0, 0, 0.4));
    margin-right:0;
    padding-left:10px;
    padding-right:10px;
...
#pulseaudio, #disk {
    color:#ead872;
    background:linear-gradient(0deg, rgba(219, 201, 99, 0.5), rgba(0, 0, 0, 0.4));
    margin-left:2px;
    margin-right:0;
    padding-left:10px;
    padding-right:11px;
...
#pulseaudio {
    ...
    margin-right:4px;
    margin-left:1px;
    box-shadow:3px 3px rgba(219, 201, 99, 0.4);
...
#pulseaudio.muted {
    margin-left:2px;
    margin-right:4px;
    box-shadow:3px 3px rgba(226, 7, 27, 0.4);
    padding-left:12px;
    padding-right:12px;
}
#+end_src
...
#memory, #backlight, #wireplumber {
    color:#a5ea9a;
    background:linear-gradient(0deg, rgba(149, 218, 138, 0.5), rgba(0, 0, 0, 0.4));
    margin-left:0;
    margin-right:0;
    padding-left:10px;
    padding-right:10px;
...
#workspaces button, #tags button {
    background:linear-gradient(0deg, rgba(5, 5, 5, 0.5), rgba(0, 0, 0, 0.5));
    padding-left:16px;
    padding-right:18px;
    margin-left:2px;
    margin-right:3px;
...
#workspaces button:hover, #tags button:hover {
    background:linear-gradient(0deg, rgba(226, 7, 27, 0.5), rgba(0, 0, 0, 0.5));
    text-shadow:inherit;
    margin-left:2px;
    margin-right:3px;
    border-radius:40px 40px 40px 40px;
    border:0px solid transparent;
    text-shadow:3px 3px rgba(226, 7, 27, 0.5);
    box-shadow:3px 2px rgba(226, 7, 27, 0.5);
}
...
#workspaces button.focused, #tags button.focused, #tags button.focused.occupied {
    background:linear-gradient(0deg, rgba(149, 218, 139, 0.5), rgba(0, 0, 0, 0.5));
    color:#efefef;
    box-shadow:3px 2px rgba(149, 218, 138, 0.5);
}
...
#workspaces button.focused:hover, #tags button.focused:hover, #tags button.focused.occupied:hover {
    text-shadow:3px 3px rgba(149, 218, 138, 0.5);
}
...
#+begin_src css :tangle sway.css
#cava {
    background:linear-gradient(0deg, rgba(226, 7, 27, 0.5), rgba(0, 0, 0, 0.3));
    color:#f2172b;
    padding-left:4px;
    padding-right:2px;
...
#keyboard-state {
    padding-left:8px;
    padding-right:5px;
    background:linear-gradient(0deg, rgba(209, 201, 99, 0.5), rgba(0, 0, 0, 0.5));
    border-radius:0px 40px 40px 0px;
    box-shadow:3px 2px rgba(209, 201, 99, 0.4);
    margin-right:4px;
    margin-left:0px;
    transition:all 0.1s ease 0s;
}
...
#temperature {
    color:#f3597f;
    background:linear-gradient(0deg, rgba(227, 73, 110, 0.5), rgba(0, 0, 0, 0.4));
}

#battery, #idle_inhibitor, #pulseaudio.bluetooth {
    color:#4facca;
    background:linear-gradient(0deg, rgba(63, 156, 185, 0.5), rgba(0, 0, 0, 0.4));
    text-shadow:2px 2px rgba(0, 0, 0, 0.6);
    transition:all 0.1s ease 0s;
}
...
#pulseaudio.bluetooth {
    ...
    padding-left:11px;
    padding-right:13px;
    box-shadow:3px 2px rgba(63, 156, 185, 0.5);
}
...
#battery {
    ...
    margin-left:0;
    margin-right:3px;
    box-shadow:3px 2px rgba(140, 154, 187, 0.4);
}

#battery.warning {
    color:#ead972;
    border-radius:0px 40px 40px 0px;
    background:linear-gradient(0deg, rgba(209, 201, 99, 0.5), rgba(0, 0, 0, 0.3));
    margin-left:0;
    margin-right:3px;
    box-shadow:3px 2px rgba(209, 201, 99, 0.5);
}
...
#bluetooth.on, #bluetooth.off, #bluetooth.disabled {
    ...
    border-radius:0px 40px 40px 0px;
    box-shadow:3px 2px rgba(226, 7, 27, 0.4);
}
...
#bluetooth.pairable:not(.connected), #bluetooth.discoverable {
    color:#4facca;
    background:linear-gradient(0deg, rgba(63, 156, 185, 0.5), rgba(0, 0, 0, 0.1));
    margin-left:0;
    margin-right:4px;
    padding-left:11px;
    padding-right:12px;
    text-shadow:2px 2px rgba(0, 0, 0, 0.7);
    border-radius:0px 40px 40px 0px;
    box-shadow:3px 2px rgba(63, 156, 185, 0.4);
}

#bluetooth.discovering {
    color:#f9ca62;
    background:linear-gradient(0deg, rgba(224, 181, 31, 0.5), rgba(0, 0, 0, 0.1));
    margin-left:0;
    margin-right:4px;
    padding-left:11px;
    padding-right:11px;
    text-shadow:2px 2px rgba(0, 0, 0, 0.7);
    border-radius:0px 40px 40px 0px;
    box-shadow:3px 2px rgba(224, 181, 31, 0.4);
}
...
#custom-clock, #network {
    color:#a3fcf6;
    background:linear-gradient(0deg, rgba(147, 236, 230, 0.5), rgba(0, 0, 0, 0.4));
    margin-left:0;
    margin-right:4px;
    padding-left:12px;
    padding-right:10px;
    border-radius:0px 40px 40px 0px;
    text-shadow:2px 2px rgba(0, 0, 0, 0.5);
    box-shadow:3px 2px rgba(147, 236, 230, 0.4);
    transition:all 0.1s ease 0s;
}
