...
- [[#login-shell-functions][Login Shell Functions]]
  ...
  - [[#wayfire][Wayfire]]
  - [[#niri][Niri]]
- [[#gui-terminal-functions][GUI Terminal Functions]]
  - [[#edit-doom-emacs-initorg][Edit Doom Emacs init.org]]
  - [[#edit-doom-emacs-configorg][Edit Doom Emacs config.org]]
  - [[#edit-foot-footorg][Edit Foot foot.org]]
  - [[#edit-qutebrowser-configorg][Edit Qutebrowser config.org]]
  - [[#edit-waybar-styleorg][Edit Waybar style.org]]
  - [[#edit-waybar-configorg][Edit Waybar config.org]]
  - [[#edit-zshorg][Edit .zsh.org]]
  - [[#aliases][Aliases]]
...
#+begin_src sh :tangle .zshrc :cache yes
        function swa() {
            export WLR_RENDERER="vulkan"
            export WLR_DRM_NO_ATOMIC=1
            export GTK_THEME="Vimix-dark-ruby"
