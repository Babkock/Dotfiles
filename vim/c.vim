...
syn keyword	cType		Window Display XEvent Visual XVisualInfo GC XImage WINDOW Colormap
...
if !exists("c_no_ansi") || exists("c_ansi_constants") || exists("c_gnu")
  ...
  syn keyword cConstant LC_NUMERIC LC_TIME SIG_DFL SIG_ERR SIG_IGN SIGABRT SIGFPE SIGILL SIGHUP SIGINT SIGSEGV SIGTERM TRUE FALSE
  syn keyword cConstant true false stdscr
