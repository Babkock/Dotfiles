...
syn keyword     TabLineSel      signal die waitpid usage main g_strdup g_strconcat g_strcmp g_strtok g_object_get g_byte_array_unref g_object_unref g_str_has_prefix g_str_has_suffix g_string_free g_string_append g_variant_new g_object_new g_signal_connect g_file_get_contents g_file_put_contents  g_io_channel_unix_new g_io_channel_set_encoding g_io_channel_set_close_on_unref g_io_add_watch g_build_filename g_path_get_dirname g_path_get_basename g_mkdir_with_parents g_strndup g_tls_certificate_new_from_file g_strdup_vprintf g_free g_chmod getpwuid g_strdup_printf XFree XUngrabKey XDestroyWindow XSetInputFocus XSetErrorHandler XUnmapWindow XSync va_start va_end spawn XCloseDisplay XQueryTree XSelectInput XSetWindowBorder XGetInputFocus XInternAtom XQueryPointer XSendEvent XGetTextProperty XFreeStringList XGrabButton XGrabKey XUngrabButton XKeycodeToKeysym XGrabServer XSetCloseDownMode XGetTransientForHint XRaiseWindow XChangeProperty XMapWindow XRefreshKeyboardMapping XAllowEvents XDeleteProperty XConfigureWindow XGetWindowAttributes XGrabPointer XMaskEvent XUngrabPointer

syn keyword     TabLineSel      XReparentWindow XFreePixmap XFreeGC XMoveResizeWindow XCopyArea XFetchName XSetForeground XFillRectangles XGetWindowProperty XWithdrawWindow XKeysymToKeycode XLowerWindow XNextEvent
